...
<span class="line"><span>    command:server/data</span></span></code></pre></div><p>跑一下：</p><p><video src="`+K+`"></video></p><p>除了界面不大一样，功能都是差不多的。</p><p>然后在代码里上传个文件；</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>pnpm install @aws-sdk/client-s3</span></span></code></pre></div><p>因为都兼容 S3 协议，所以所有对象存储服务都可直接使用 AWS 官方 S3 SDK；</p><p>前面我们用 ali-oss、minio 写的代码也都可以换成这个 sdk</p><p>创建 src/s3-upload.mjs</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import &#39;dotenv/config&#39;;</span></span>
