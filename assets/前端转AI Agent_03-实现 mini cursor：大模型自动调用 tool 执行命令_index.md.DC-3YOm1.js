import{_ as n,a,b as p,c as e,d as l,e as i,f as o,g as c,h as t,i as r,j as d,k as m,l as g,m as u,n as h,o as _,p as f,q as b,r as v}from"./chunks/image-20260128133640928.D33_uFcD.js";import{_ as k,o as y,c as w,ag as x}from"./chunks/framework.BYTi4OdY.js";const j=JSON.parse('{"title":"03-实现 mini cursor：大模型自动调用 tool 执行命令","description":"","frontmatter":{},"headers":[],"relativePath":"前端转AI Agent/03-实现 mini cursor：大模型自动调用 tool 执行命令/index.md","filePath":"前端转AI Agent/03-实现 mini cursor：大模型自动调用 tool 执行命令/index.md"}'),q={name:"前端转AI Agent/03-实现 mini cursor：大模型自动调用 tool 执行命令/index.md"};function $(T,s,C,P,A,D){return y(),w("div",null,[...s[0]||(s[0]=[x('<h1 id="_03-实现-mini-cursor-大模型自动调用-tool-执行命令" tabindex="-1">03-实现 mini cursor：大模型自动调用 tool 执行命令 <a class="header-anchor" href="#_03-实现-mini-cursor-大模型自动调用-tool-执行命令" aria-label="Permalink to &quot;03-实现 mini cursor：大模型自动调用 tool 执行命令&quot;">​</a></h1><p>上节我们给大模型扩展了读文件的 tool，你说一个文件路径让它解释，它就可以自动调工具读文件内容给出解释了。</p><video src="'+n+'" controls></video><p>那继续思考：</p><p>如果我们给它扩展了执行命令、写文件、创建目录、读取目录、读文件等 tool，是不是就能实现 cursor 的功能呢？</p><p>比如创建项目对文件做增删改：</p><video src="'+a+'" controls></video><p>项目创建后自动执行命令安装依赖和跑服务：</p><video src="'+p+'" controls></video><p>是不是现在就可以实现了！</p><p><img src="'+e+`" alt="image-20260128133203513"></p><p>虽然我们不会做那么完善，但是简易版确实可以写了。</p><p>这节我们就来实现下大模型根据 prompt 生成项目代码，自动读写文件、通过命令安装依赖、自动把项目跑起来，全程自己调用 tool 的功能：</p><p>不创建新项目了，直接在上节的 tool-test 项目继续写。</p><p>首先， node 里如何执行命令呢？</p><p>用 child_process 这个内置模块。</p><p>创建 src/node-exec.mjs</p><div class="language-plain text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>import { spawn } from&#39;node:child_process&#39;;</span></span>
