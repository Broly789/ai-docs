import{_ as n,a,b as p,c as e,d as l,e as o,f as t,g as i,h as c,i as r,j as u,k as d,l as m,m as g,n as h,o as q,p as _,q as b,r as v,s as y,t as O,u as f,v as k}from"./chunks/image-20260128155429626.p2xOBk09.js";import{_ as A,o as z,c as P,ag as E}from"./chunks/framework.lghGfHnE.js";const M=JSON.parse('{"title":"12-结构化大模型输出：Output Parser 还是 tool？","description":"","frontmatter":{},"headers":[],"relativePath":"前端转AI Agent/12-结构化大模型输出：Output Parser 还是 tool？/index.md","filePath":"前端转AI Agent/12-结构化大模型输出：Output Parser 还是 tool？/index.md"}'),C={name:"前端转AI Agent/12-结构化大模型输出：Output Parser 还是 tool？/index.md"};function I(x,s,w,N,S,$){return z(),P("div",null,[...s[0]||(s[0]=[E(`<h1 id="_12-结构化大模型输出-output-parser-还是-tool" tabindex="-1">12-结构化大模型输出：Output Parser 还是 tool？ <a class="header-anchor" href="#_12-结构化大模型输出-output-parser-还是-tool" aria-label="Permalink to &quot;12-结构化大模型输出：Output Parser 还是 tool？&quot;">​</a></h1><p>我们已经调用大模型完成过很多功能了，但输出一直没做控制，都是自然语言的形式。</p><p>而很多情况下，我们希望大模型按照我们的格式要求，返回一个 json</p><p>这就需要用到 Output Parser 的 api 了。</p><p>有同学说，这个不就是在 prompt 里描述下要什么格式，然后按照这种格式解析大模型返回的结果字符串么？</p><p>没错，就是这种思路，只不过 output parser 对这个思路做了一下封装。</p><p>我们直接写代码来试一下：</p><div class="language-plain text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">plain text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>mkdir output-parser-test</span></span>
