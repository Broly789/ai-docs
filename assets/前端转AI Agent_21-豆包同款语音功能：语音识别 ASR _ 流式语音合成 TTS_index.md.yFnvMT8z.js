import{_ as n,o as a,c as p,ag as e}from"./chunks/framework.lghGfHnE.js";const l="/ai-docs/assets/1.nhxF2sD3.mp4",i="/ai-docs/assets/2.DImOphzl.mp4",t="/ai-docs/assets/3.CE8Qa0qM.mp4",c="/ai-docs/assets/4.BWnz4AUi.mp4",o="/ai-docs/assets/5.CIuaTG9A.mp4",r="/ai-docs/assets/6.BKgUFMCh.mp4",m="/ai-docs/assets/7.BN1ZzxNz.mp4",d="/ai-docs/assets/8.ClO8LYGz.mp4",S=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"前端转AI Agent/21-豆包同款语音功能：语音识别 ASR + 流式语音合成 TTS/index.md","filePath":"前端转AI Agent/21-豆包同款语音功能：语音识别 ASR + 流式语音合成 TTS/index.md"}'),u={name:"前端转AI Agent/21-豆包同款语音功能：语音识别 ASR + 流式语音合成 TTS/index.md"};function g(f,s,h,b,q,v){return a(),p("div",null,[...s[0]||(s[0]=[e(`<p>我们常用的 Agent 都有语音功能。</p><p>语音输入会转成文字，大模型的回答会通过语音朗读。可以切换音色。</p><p>这种 STT（Speech To Text）语音转文字，TTS（Text To Speech）文字转语音基本是 Agent 开发必备技术了。</p><p>这节我们就来学一下语音相关技术，实现豆包同款功能。</p><p>创建项目：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>mkdir tts-stt-test</span></span>
