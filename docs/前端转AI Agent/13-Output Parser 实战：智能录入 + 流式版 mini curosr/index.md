# 13-Output Parser 实战：智能录入 + 流式版 mini curosr
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdA840e9djFxnpOuRW1bYX6ojqOj9GyuGN3vj6d5BE8cJxFkubPfCN5g/640?wx_fmt=png&from=appmsg&wxfrom=13&tp=wxpic#imgIndex=0)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdDQDKWSFD0vUIiaLXQM5T0XVn9kLQhXAib9O0iaBOAicAuFRy4233RMLqUQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=1)

这需要你把数据按结构整理好，代码里解析出来保存到数据库。

但在 AI 时代，一般都是智能录入的：

![图片](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfcLmNHCNddJTGrrEibAFHwBbzCnYcb4j2ZNkax4DGeQykSXQW8V5ngibXWI57VwQ2X0NlzicUTNDESrVUR4RoDA1paf5ZlC6B8JDE/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=2)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibd1N3IAYhPZlJuc73mfUTwyEBWznayb7ymeIb6JzQJGNXzB9tElKvAIA/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=3)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdX2NsNQt2K8jHghiaKCiaYzv9pBYCnlMFtSWaRcNWgnVDuFXGT4deh69A/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=4)

下载后安装：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdQtPDWnGgcSSicEIfbsz2F41piaGZaxdQYfsCbQlrLppicaX0KNRCO5Cmg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=5)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdAJc8uEkdLdoia91dq8YcyYBr3hOeVXwLgvLAeiaWX9lYgbyITsMjeDYA/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=7)

把这个 AIMessage 也加入 memory

之后根据 AIMessage 中的 tool_calls 信息调用 tool，执行结果封装成 ToolMessage 放入 memory

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdvibhhKu4XtFtRlqMbZLZR63D99gVLfRFrxhs0iaV3haJsDVsbYpMe9Xw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=8)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdrGt7BCurl8fxwX16HDOUsIddMqIm69OqibINEzOh14VTOv6PqU1nNew/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=9)

我们要把 AIMessageChunk 拼接成完整的 AIMessage 才能放入 Memory 再次调用大模型。

这个用它的 contact 方法即可。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdVNMD5WTQcxVibxu0AROz5Mf5ibHrdbUMNibUstpCE2VTicqhGgpxu0kDnA/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=10)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdESBz0ribmnKTia162MiavOpLr9ibzfEtEyIq5a3yQibUrWR5ZicLWyzn13nA/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=13)

并不是一个合法 json

而用了 JsonOutputToolsParser 之后：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdDRHeAVECoQtWakVibnJKe1uvXHjmUY1E1QFk7vT3TLqg3E120f5zEug/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=14)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdYByMZd3QibZvURW3J1nk3O8EoaNWcup2iarBTkpur7lslpjTYoeia8B9A/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=15)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdibVjGNHuVPO7xYsucq9bOaW5C1ia3ll6Su9XULtzUgHe2QrnnN0VlILA/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=16)

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdXuv5KfU4TnuVeMDoAj5JJwiapibMictT0Z6kdOYBicSicd5ggM4h3cMQgTg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=17)

然后先看 AIMessageChunk 的拼接：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdMBuuz2j0tDgb8lwSmfcyu8M1OusibiaDkjiczicXXUOhmwicygYlXvDOQHg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=18)

用 concat 来拼接。

当 chunk 遍历完，自然也就拼好了，这时候就放入 memory：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdpdfcIJIwgVelFX9icic7O67WticJxibnpcMsA00ZycPZMt3OfuiafHOmR7A/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=19)

另外就是 tool_call_chunks，这个用 JsonOutputToolsParser 来解析：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibd3jtr4ib7VevvuczJWoIsFTZq5RUia4bzW0hFObmW0cyB7e63NUmcibibUg/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=20)

调用它的 parseResult 方法，传入我们 concat 好的部分 AIMessage

我们加了一个 Map 来记录已经打印过的长度，下次 slice 一下，继续打印后面的。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdYwnE7taibXZF3IZV505tiaWibic7iaNS88caygUzlRkyg4FETp0s1apzRibw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=21)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibduG6Ahdn5j1q7gyHXfnDHqfPAtJqFsEGpBO4ylOZ4f2B0YTgGL9KrDw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=22)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdvibhhKu4XtFtRlqMbZLZR63D99gVLfRFrxhs0iaV3haJsDVsbYpMe9Xw/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=23)

现在需要自己对 AIMessageChunk 做 concat，以及用 JsonOutputToolsParser 解析 tool_call_chunks：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/JnZIbTicL4jU63rKH6ZjzIUlFRyc7X4ibdYByMZd3QibZvURW3J1nk3O8EoaNWcup2iarBTkpur7lslpjTYoeia8B9A/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=24)
