...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfcqfaNOtZxaawOfQzTKPLjplRB6Mc4aCy2TiaxoFPgCoLUH3dmDGx3OU8jfSNLkJ0s4icS83zEocFW2fapMYL9MXarVoPgxsyMmw/640?wx_fmt=png&from=appmsg&wxfrom=13&tp=wxpic#imgIndex=0)

声明的 chain 可以用 invoke、batch、stream 等 api 来同步调用、批量调用、流式返回，因为所有 Runnable 都实现了这些方法。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwfeicgyodEtibMK5ibXyXaReD9qJlHP9ZGgBQ40KUr5JqvulIK99yNw6ZOWoAUzshiaBibKWHXr8VhCjMia9qhlib2a5EQUdr8tOhHhTVg/640?wx_fmt=png&from=appmsg&wxfrom=13&tp=wxpic#imgIndex=1)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwfcP1Qzia0G3TBWbwLYX5a2GjDn463XYonhWfNib7tuxD04jgTt4pJbTicOIO19S05RV1JTMUESmNIHWMFPehqXwL8zGDpBibeoAS2s/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=2)

然后用 Runnable 的方式写下逻辑：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwfeBStPVEWicLzFSfRKiaF4btoPjnw6HQERf7MWA03dlfPDgvnA3icOVAtChQRrMaHzErs9D7CuNmXoshv7hyBrP0qeWfZVFjKoaNE/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=3)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwffqb4qicmjCNFiagX8b0GTWfNgibTq6EnW4pNRc7f0H3h7SH22ibKDUUDDzbNPhXLG37VoV5mTWamd5vvfcPPuu6l6ib7B85jCMiadiaQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=4)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfcG1w2f9ThaVFJxUk0GqibTzhmrQWHtdlppVK7ibA78PRdicGPLQ0z9CTEicC8Wb9SzXhCvZ3eoicoqbTAeffdUZcS72YbiapueEdLick/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=5)

这样，整个 chain 就串联好了。

之后统一 invoke 这个组装好的 chain：

![图片](https://mmbiz.qpic.cn/mmbiz_png/NMByQQfVwfd1Bticp8DITCEic8czGEBMrvneiakK2X59BvdvWUWfiabh4dQqsdE5JfwynaWK5n3beUuLlNUibBxcREuzhcrl4ZwpkU6q9JuvnV8Y/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=6)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwfeZfSV5EJn12GhJibSBLXJbsnDKBLuHSRAeib4KTboMzvUAtXl0qGSRib8tjibxmIiaYUJe90icicqnSUiaCFbo78mJW6QibdosrwKOh5TQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=7)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/NMByQQfVwfc3vLj5US9f3EiaNk1VWWkhiaic5aiaJvianQbeUJSytaOKObukETU6lCrNP6tL4iaDtbzwNnkHhczoF5pqme3XocR8PfPGPgSahnNXQ/640?wx_fmt=png&from=appmsg&tp=wxpic&wxfrom=5&wx_lazy=1#imgIndex=8)
